...
public class WebServiceServiceLocator extends org.apache.axis.client.Service implements com.tw.WebServiceService {
    ...
    private java.lang.String WebService_address = "http://localhost:9453/WebServiceServer/services/WebService";
    ...
    public com.tw.WebService getWebService() throws javax.xml.rpc.ServiceException {
    ...
    public com.tw.WebService getWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.tw.WebServiceSoapBindingStub _stub = new com.tw.WebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.tw.WebService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.tw.WebServiceSoapBindingStub _stub = new com.tw.WebServiceSoapBindingStub(new java.net.URL(WebService_address), this);
                _stub.setPortName(getWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tw.com", "WebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tw.com", "WebService"));
        }
