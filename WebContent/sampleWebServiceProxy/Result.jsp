...
<jsp:useBean id="sampleWebServiceProxyid" scope="session" class="com.tw.WebServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        com.tw.WebService getWebService10mtemp = sampleWebServiceProxyid.getWebService();
...
case 13:
        gotMethod = true;
        java.lang.String helloWorld13mtemp = sampleWebServiceProxyid.helloWorld();
